        ...
        BuiltinRule {
            ...
            body: substitute_builtin_vars(
                concat!(
                    ...
                    "\n",
                    "To change the code: just change it. It is the leaf and nothing depends on it.\n",
                    "\n",
                    ...
                    "\n",
                    "To change the canon: every design is nuked first, and therefore all the code beneath them ",
                    "too. Then the canon is edited, then designs are written afresh from it, then code from ",
                    "those.\n",
                    "\n",
                    ...
                    "way a design round closes: moved into `{mock_dir}/canon/archive/` with a timestamp, so the ",
                    "superseded canon is dated, kept, and marked stale rather than overwritten in place.\n",
                    "\n",
                    ...
                    "\n",
                    "Declaring the designs and code stale is not a quality complaint. It is the precondition ",
                    "the mutation order requires: while a design is live, the canon above it is frozen, and ",
                    "declaring the design dead is what unfreezes the canon. An agent that consults current ",
                    "designs or shipped source while editing the canon is reattaching a tier that had to be ",
                    "detached for the edit to be permitted, and every observation it brings back is a fact ",
                    "about a document already declared dead.\n",
                    "\n",
                    ...
                    "invalidation cascading through those relations the way nuking a canon already cascades to ",
                    "every design beneath it. That is anticipated and **not specified**. It stays unspecified ",
                    "on purpose: how it should work in practice is not yet known, and the plan is to dogfood ",
                    "the three-tier shape first, see what actually happens across real canon work, and ",
                    "formalise the relation and cascade mechanism from that experience rather than from ",
                    "guesswork now. Do not invent a relation or cascade mechanism ahead of that. And do not ",
                    "read its absence as meaning canon files are independent of one another; absence here ",
                    "means undecided, not decided-independent.\n",
                    "\n",
                    ...
                    "unbuilt: the mutation-order guard (refusing an edit to `{mock_dir}/canon/` outside ",
                    "`archive/` while any design document remains under `{mock_dir}/crates/`), the ",

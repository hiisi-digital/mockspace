        ...
        BuiltinRule {
            ...
            body: substitute_builtin_vars(
                concat!(
                    ...
                    "2. **DESIGN.md.tmpl** -- overview with sections, generates per-crate overview doc\n",
                    "3. **DEEPDIVE_*.md.tmpl** -- topic-specific deep dives\n",
                    "\n",
                    "### Design rounds\n",
                    "No design modification without a completed design round document in `design_rounds/`. Each round has \"Current state\" and \"Changes proposed\" sections.\n",
                    "\n",
                    "### Validation pipeline\n",

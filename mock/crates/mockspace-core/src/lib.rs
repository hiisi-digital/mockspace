...
pub use lint::{
    ...
    LintContext, LintEngine, LintError, MetadataBlob, Project, RelatedSpan, RunSurface,
    ScopeAxis, Severity, Span, Suggestion, SuppressionMap, SuppressionScope, matches_pattern,
};
pub use manifest::{

...
/// Format a unix epoch as a minimal ISO-8601 UTC string. Shares the
/// algorithm with the CLI's [`run_task_new`] formatter. Howard
/// Hinnant civil-from-days; stdlib-only.
